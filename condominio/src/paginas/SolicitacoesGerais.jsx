...
const SolicitacoesGerais = () => {
    ...
    return (
        ...
        <div>
            ...
            <h1 style={{ textAlign: 'center' }} >Solicitações Gerais</h1>
                    ...
                    <Form>
                        <Form.Group controlId="formIdCondominio">
                            ...
                            <div className="form-check form-check-inline">
                                <input type="checkbox" className="form-check-input" id="urgenciaCheck" />
                                <label htmlFor="urgenciaCheck" className="form-check-label text-secondary"><small>Urgência</small></label>
                            </div>
                            <div className="form-check form-check-inline">
                                <input type="checkbox" className="form-check-input" id="reservaCheck" />
                                <label htmlFor="reservaCheck" className="form-check-label text-secondary"><small>Reserva</small></label>
                            </div>
                        </Form.Group>
                    </Form>
...
export default SolicitacoesGerais;
